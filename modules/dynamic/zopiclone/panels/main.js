...
var main__ID=function(){
	...
	L[A+'Adverse_Event']=       {table_id:'20000395',var:v,url:T+'/adverse_event_and_concom/Adverse_Event_meddra.html'};
    L[A+'meddra_search']=        {table_id:visit_booking_tid,    var:v,  url:T+'/adverse_event_and_concom/meddra.html'};    
